...
<footer class="footer1">
    <div class="footer1-widgets">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-sm col-xs-12">
                    <div class="widget">
                ...
                <div class="col-md-4  col-sm-12 hidden-xs">
                    <div class="widget widget-categories">
                        ...
                        <ul>
                            <li>
                                <a href="<?php echo base_url(); ?>"><?php echo translate('home');?>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url('meticulous/shop'); ?>"><?php echo translate('shop');?>
                                </a>
                            </li> 
                            ...
                            <?php }?>
                            <li>
                                <a href="<?php echo base_url(); ?>meticulous/contact/"><?php echo translate('contact');?>
                                </a>
                            </li> 
                        </ul>
                    </div>
                    ...
                    <div class="widget contact">
                        ...
                        <div class="media-list"> 
                            ...
                            <ul class="social-nav model-2" style="float: left;margin-top: 10px">
                                ...
                                ?>
                                <li style="border-top: none;"><a href="<?php echo $instagram;?>" class="instagram social_a"><i class="fa fa-instagram"></i></a></li>
                                <?php 
                                } if ($twitter != '') {
                                ?>
                ...
                <div class="col-md-8 col-xs-12">
                    <div class="copyright" version="Currently <?= demo()?'demo':''?> v<?php echo $this->db->get_where('general_settings',array('type'=>'version'))->row()->value; ?>">
                        ...
                        <a href="<?php echo base_url(); ?>">
                            ...
                            | 
                        <a href="<?php echo base_url(); ?>meticulous/legal/terms_conditions" class="link">
                            <?php echo translate('terms_&_condition'); ?>
                        </a> 
                            | 
                        <a href="<?php echo base_url(); ?>meticulous/legal/privacy_policy" class="link">
