        ...
        <div class="container">
            ...
            <nav class="navigation closed clearfix">
                ...
                <ul class="nav sf-menu">
                    ...
                    <li <?php if($page_name=='shop'){ ?>class="active"<?php } ?>>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li class="<?php if($others_list=='latest'){ echo 'active'; } ?>">
                                <a href="<?php echo base_url(); ?>meticulous/others_product/latest">
                            ...
                            ?>
                            <li>
                                <a href="<?php echo base_url(); ?>meticulous/page/<?php echo $row2['parmalink']; ?>">
