                            ...
                            <table>
                                <tr>
                                    <td class="brand-image">
										...
										?>
										<img class="image_delay" itemprop="image" src="<?php echo img_loading(); ?>" data-src="<?php echo base_url();?>uploads/brand_image/<?php echo $this->crud_model->get_type_name_by_id('brand',$row3,'logo'); ?>" alt=""/>
										<?php
											} else {
										?>
										<img  class="image_delay" itemprop="image" src="<?php echo img_loading(); ?>" data-src="<?php echo base_url(); ?>uploads/brand_image/default.jpg" />
										<?php
											}
										?>
                                    </td>
