            ...
            <div class="col-md-5">
                <div class="contact-info contact_bg">
                    ...
                    <div class="media-list">  
                        ...
                        ?>
                        <div class="media">
                            <i class="pull-left fa fa-facebook"></i>
                            <div class="media-body">
                                <strong><?php echo translate('facebook');?>:</strong><br>
                        ...
                        ?>
                        <div class="media">
                            <i class="pull-left fa fa-twitter"></i>
                            <div class="media-body">
                                <strong><?php echo translate('twitter');?>:</strong><br>
