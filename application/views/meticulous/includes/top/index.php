...
<!-- CSS Main -->
<link href="<?php echo base_url(); ?>template/meticulous/style.css" rel="stylesheet">   
...
<!-- Head Libs -->
<script src="<?php echo base_url(); ?>template/meticulous/js/jquery.min.js"></script>
<?php
$font =  $this->db->get_where('ui_settings',array('type' => 'font'))->row()->value;
?>
<link href='https://fonts.googleapis.com/css?family=Open+Sans<?php //echo $font; ?>:300,400,600,700|Playfair+Display:400,700' rel='stylesheet' type='text/css'>
<style> 
    .remove_one{
        cursor:pointer;
        padding-left:5px;
