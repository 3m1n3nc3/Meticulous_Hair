<section class="page-section color get_into">
    <div class="container" id="login">
        <div class="row margin-top-0">
            <div class="col-lg-6 offset-lg-3 col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-xs-12">
                ...
                <?php
                    echo form_open(base_url() . 'meticulous/login/do_login/', array(
                        'class' => 'form-login',
                        'method' => 'post',
                        'id' => ''
                    ));
                ...
                ?>
                    ...
                    <div class="row box_shape">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-right float-right">
                            <span class="forgot-password" style="cursor:pointer;" onClick="set_html('login','forget')">
                                <?php echo translate('forget_your_password_?');?>
                            </span>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <span class="btn akame-btn active btn-block btn-theme-dark float-right login_btn enterer">
                        ...
                        <?php if($fb_login_set == 'ok'){ ?>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if($g_login_set !== 'ok'){ ?>mr_log<?php } ?>">
                                <?php if (@$user): ?>
                                    <a class="btn akame-btn active btn-block btn-icon-left facebook" href="<?= $url ?>">
                        ...
                        <?php } if($g_login_set == 'ok'){ ?>  
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 <?php if($fb_login_set !== 'ok'){ ?>mr_log<?php } ?>">
                                <?php if (@$g_user): ?>
                                    <a class="btn akame-btn active btn-block btn-icon-left google" style="background:#ce3e26" href="<?= $g_url ?>">
    ...
    <div class="container" id="forget" style="display:none">
        <div class="row margin-top-0">
            <div class="col-lg-6 offset-lg-3 col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-xs-12">
                <?php
                    echo form_open(base_url() . 'meticulous/login/forget/', array(
                        'class' => 'form-login',
                        'method' => 'post',
                        'id' => 'forget_form'
                    ));
