...
?>
    ...
    <div class="comments-form tickets">
        ...
        <?php
            echo form_open(base_url() . 'meticulous/ticket_reply/'.$row['ticket_id'], array(
    ...
    <script>
        ...
        function set_message_box(){
            $('#all_messages_box').load('<?php echo base_url(); ?>meticulous/profile/message_box/<?php echo $row['ticket_id']?>');
        }
    </script>   
<?php 
    }
