    ...
    <tr>
        ...
        <td class="view_details">
            <?php 
                ...
                ?>
                    <span class="btn btn-info btn-sm" style="cursor:pointer;" onclick="view_package_details('<?php echo base_url(); ?>meticulous/profile/view_package_details/<?php echo $row1['package_payment_id']; ?>')" >
...
<script>
    function product_status(status, id, now){
        $.ajax({
            url: "<?=base_url()?>meticulous/customer_product_status/"+status+"/"+id,
