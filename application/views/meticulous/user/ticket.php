                ...
                <div class="tabs-wrapper content-tabs">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade in active show" id="tab1">
                            ...
                            <script>                                                                    
                                function ticket_listed(page){
                                    ...
                                    var alerta = $('#result6');
                                    alerta.load('<?php echo base_url();?>meticulous/ticket_listed/'+page,
                                        function(){
                                            //set_switchery();
                                        }
                                    );   
                        ...
                        <div class="tab-pane fade" id="tab2"> 
							<?php echo form_open(base_url() . 'meticulous/ticket_message_add/', array(
                                    'class' => 'form-login form-row',
                                    'method' => 'post',
                                    'id' => 'add_ticket',
...
<script>
	$('body').on('click','.message_view',function(){
		var id = $(this).data('id');
		$("#window").load("<?php echo base_url()?>meticulous/profile/message_view/"+id);
	});
