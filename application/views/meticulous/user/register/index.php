    ...
    <div class="container">
        <div class="row margin-top-0">
            <div class="col-sm-8 offset-md-2">
				...
				<?php
                    echo form_open(base_url() . 'meticulous/registration/add_info/', array(
                        'class' => 'form-login',
                        'method' => 'post',
                        'id' => 'sign_form'
                    ));
                ...
                ?>
                	...
                	<div class="row box_shape">
                        ...
                        <div class="col-md-12 terms">
                            ...
                            <a href="<?php echo base_url();?>meticulous/legal/terms_conditions" target="_blank">
						...
						?>
                        <div class="col-md-12">
                            <span class="btn akame-btn active btn-block btn-theme-dark pull-right logup_btn" data-ing='<?php echo translate('registering..'); ?>' data-msg="">
