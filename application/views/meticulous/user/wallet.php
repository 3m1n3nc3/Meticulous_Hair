    ...
    <div class="col-lg-3 col-md-3 col-sm-4">
        ...
        <div class="row" >
            <div class="col-md-12" style="margin-top:2px;" >
                <div class="btn btn-theme btn-theme-sm btn-block" onclick="wallet('<?php echo base_url(); ?>meticulous/profile/wallet/add_view')">
    ...
    <div class="col-lg-9 col-md-9 col-sm-8">
        ...
        <script>                                                                    
            function wallet_listed(page){
                ...
                alerta.load('<?php echo base_url();?>meticulous/wallet_listed/'+page,
                    function(){
                        //set_switchery();
                    }
                );   
