                    	...
                    	<div class="details-wrap">
                            ...
                            <?php if ($upload_amount <= 0){ ?>
                                ...
                                <div class="text-center">
                                    <a href="<?=base_url()?>meticulous/premium_package" class="btn btn-theme"><?=translate('purchase_package')?></a>
                                </div>
                            <?php } else { ?>
                                <p class="text-success"><?=translate('remaining_product_upload_amount:_').$upload_amount;?></p>
                                <div class="details-box">
                                    <?php
                                        echo form_open(base_url() . 'meticulous/profile/do_post_product/', array(
                                            'class' => 'form-login',
                                            'method' => 'post',
                                    ...
                                    ?>    
                                        <div class="row">
                                            ...
                                            <div class="col-md-12" style="border-top: 1px #3c3c3c">
                                                <div class="form-group">
                                                    <div>
                                                        <label><?=translate('Seo')?></label><br>
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="col-md-12"><span>*<?php echo translate('Write an seo friendly title within 60 characters')?></span></div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input class="form-control" name="seo_title" value="" type="text" placeholder="<?php echo translate('Ex. Yamaha RT - Model 2020')?>"
                                                           data-toggle="tooltip" title="<?php echo translate('Seo Friendly Title');?>">
                                                </div>
                                            </div>
                                            <br>
                                            <div class="col-md-12"><span>*<?php echo translate('Write an seo friendly description within 160 characters')?></span></div>
                                            <div class="col-md-12">
                                                <div class="">
                                                    <textarea class="form-control" name="seo_description" placeholder="<?php echo translate('Ex. New Yamaha Sports bike in 2020 from Japan')?>"
                                                              data-toggle="tooltip" title="<?php echo translate('Seo Friendly Description');?>" style="height: 300px;"></textarea>
                                                </div>
                                            </div>
...
<script>
    ...
    function get_sub_cat(category_id) {
        ajax_load(base_url+'meticulous/get_dropdown_by_id/sub_category/category/'+category_id+'/sub_category_name/0','post_sub_category', 'set_elements');
    }
