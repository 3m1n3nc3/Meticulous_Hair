    ...
    <tr>
        ...
        <td class="total">
            <?php if($row1['status'] == 'due'){ ?>
                <span class="btn btn-danger btn-sm" style="cursor:pointer;" onclick="wallet('<?php echo base_url(); ?>meticulous/profile/wallet/info_view/<?php echo $row1['wallet_load_id']; ?>')" >
                    <?php echo translate('provide_payment_info');?>
                </span>
            <?php } else if($row1['status'] == 'paid' || $row1['status'] == 'pending') { ?>
                <span class="btn btn-info btn-sm" style="cursor:pointer;" onclick="wallet('<?php echo base_url(); ?>meticulous/profile/wallet/info_view/<?php echo $row1['wallet_load_id']; ?>')" >
