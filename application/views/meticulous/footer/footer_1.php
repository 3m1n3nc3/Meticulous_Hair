        ...
        <div class="container custom-footer1-widgets">
            <div class="row justify-content-between">
                ...
                <div class="col-12 col-sm-6 col-md-4 mb-30">
                    <div class="single-footer-widget widget">
                        <!-- Footer Logo -->
                ...
                <div class="col-12 col-sm-6 col-md-4 col-xl-3 mb-30">
                    <div class="single-footer-widget">
                        ...
                        <div class="contact-address"> 
                            <p> 
                                <a href="<?php echo base_url(); ?>" style="color: unset;"><?php echo translate('home');?></a>
                            </p> 
                            <p> 
                                <a href="<?php echo base_url('meticulous/shop'); ?>" style="color: unset;">
                                    <?php echo translate('shop');?>
                                </a>
                            </p> 
                            <?php if($about = $this->db->where('parmalink', 'about')->or_like('parmalink', 'about')->get('page')->row_array()) {?>
                            <p> 
                                <a href="<?php echo base_url('meticulous/page/'.$about['parmalink']); ?>" style="color: unset;">
                                    <?php echo $about['page_name'];?>
                                </a>
                            </p> 
                            <?php }?>
                            <p> 
                                <a href="<?php echo base_url('meticulous/contact'); ?>" style="color: unset;">
