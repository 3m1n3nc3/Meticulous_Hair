		...
		<div class="container">
			<div class="row product-single" style="margin-top: 0px">
				<div class="col-md-7">
                	<div class="digital_gallery">
                        <div class="owl-carousel img-carousel">                                            
                            ...
                            ?>
                            <div class="item">
                                <img itemprop="image" class="img-responsive" style="width:100%;" src="<?php echo $row1; ?>" alt=""/>
                            </div>
                            <?php 
                                }
                            ?>
				...
				<div class="col-md-5">
                    ...
                    <div class="added_by" class="added_by" itemscope itemtype="http://schema.org/Store">
