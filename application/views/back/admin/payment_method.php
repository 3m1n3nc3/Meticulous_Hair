<?php
    ...
    $esp_val    = $this->db->get_where('business_settings', array(
        'type' => 'express_shipping_cost'
    ))->row()->value;
    $isp_val    = $this->db->get_where('business_settings', array(
        'type' => 'international_shipping_cost'
    ))->row()->value;
                ...
                <div class="col-md-12">
                    <div class="panel panel-bordered panel-dark">
                        ...
                        <div class="panel-body" style="background:#fffffb;">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label" ><?php echo translate('express_shipping_cost_(If_fixed)');?> (<?php echo currency('','def'); ?>)</label>
                                <div class="col-sm-6">
                                    <input type="text" name="express_shipping_cost"
                                        value="<?php echo $esp_val; ?>"
                                            class="form-control">
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-3 control-label" ><?php echo translate('international_shipping_cost_(If_fixed)');?> (<?php echo currency('','def'); ?>)</label>
                                <div class="col-sm-6">
                                    <input type="text" name="international_shipping_cost"
                                        value="<?php echo $isp_val; ?>"
                                            class="form-control">
                                </div>
                            </div>
