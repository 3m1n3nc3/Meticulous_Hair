        ...
        <div class="text-center pad-all">
            ...
            <div class="col-md-9">   
                <table class="table table-striped" style="border-radius:3px;">
                    ...
                    <?php } if($row['express_shipping_cost'] != ''){ ?>
                    <tr>
                        <th class="custom_td"><?php echo translate('express_shipping_cost');?></th>
                        <td class="custom_td"><?php echo $row['express_shipping_cost']; ?> / <?php echo $row['unit']; ?></td>
                    </tr>
                    <?php } if($row['international_shipping_cost'] != ''){ ?>
                    <tr>
                        <th class="custom_td"><?php echo translate('international_shipping_cost');?></th>
                        <td class="custom_td"><?php echo $row['international_shipping_cost']; ?> / <?php echo $row['unit']; ?></td>
                    </tr>
                    <?php } if($row['tax'] != ''){ ?>
                    <tr>
