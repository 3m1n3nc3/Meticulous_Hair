                    ...
                    <div class="tab-content">
                        ...
                        <div id="business_details" class="tab-pane fade">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" name="express_shipping_cost" min='0' id="demo-hor-18" min='0' step='.01' placeholder="<?php echo translate('express_shipping_cost');?>" class="form-control">
                                </div>
                                <span class="btn"><?php echo currency('','def'); ?> / </span>
                                <span class="btn unit_set"></span>
                            </div>
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" name="international_shipping_cost" min='0' id="demo-hor-19" min='0' step='.01' placeholder="<?php echo translate('international_shipping_cost');?>" class="form-control">
                                </div>
                                <span class="btn"><?php echo currency('','def'); ?> / </span>
                                <span class="btn unit_set"></span>
                            </div>
