                ...
                <div class="tab-base">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="business_details" class="tab-pane fade">
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-18"><?php echo translate('express_shipping_cost');?></label>
                                <div class="col-sm-4">
                                    <input type="number" name="express_shipping_cost" min='0' id="demo-hor-18" min='0' step='.01' value="<?php echo $row['express_shipping_cost']; ?>" placeholder="<?php echo translate('express_shipping_cost');?>" class="form-control">
                                </div>
                                <span class="btn"><?php echo currency('','def'); ?> / </span>
                                <span class="btn unit_set"><?php echo $row['unit']; ?></span>
                            </div>
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-19"><?php echo translate('international_shipping_cost');?></label>
                                <div class="col-sm-4">
                                    <input type="number" name="international_shipping_cost" min='0' id="demo-hor-19" min='0' step='.01' value="<?php echo $row['international_shipping_cost']; ?>" placeholder="<?php echo translate('international_shipping_cost');?>" class="form-control">
                                </div>
                                <span class="btn"><?php echo currency('','def'); ?> / </span>
                                <span class="btn unit_set"><?php echo $row['unit']; ?></span>
                            </div>
