...
class Crud_model extends CI_Model
{
    ...
    function get_shipping_cost($product_id, $type = 'shipping')
    {
        $price = $this->get_type_name_by_id('product', $product_id, 'sale_price');
        $shipping = $this->get_type_name_by_id('product', $product_id, $type . '_cost');
    ...
    function month_total($type, $filter1 = '', $filter_val1 = '', $filter2 = '', $filter_val2 = '', $notmatch = '', $notmatch_val = '')
    {
        ...
        if ($type == 'sale') {
            ...
            if ($this->session->userdata('title') == 'admin') {
                $this->db->get_where('stock', array('added_by' => json_encode(array('type' => 'vendor', 'id' => $this->session->userdata('vendor_id')))));
                $this->db->get_where('stock', array(
                    'datetime >= ' => $ago,
                    'datetime <= ' => time()
                ));
