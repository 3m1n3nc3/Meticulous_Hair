...
class Admin extends CI_Controller
{
    ...
    function product($para1 = '', $para2 = '', $para3 = '')
    {
        ...
        if ($para1 == 'do_add') {
            ...
            $data['express_shipping_cost']       = $this->input->post('express_shipping_cost');
            $data['international_shipping_cost'] = $this->input->post('international_shipping_cost');
   ...
   /* Manage Frontend Captcha Settings Credentials */
    ...
    function business_settings($para1 = "", $para2 = "", $para3 = "")
    {
        if (!$this->crud_model->admin_permission('business_settings')) {
            ...
            $this->db->where('type', "express_shipping_cost");
            $this->db->update('business_settings', array(
                'value' => $this->input->post('express_shipping_cost')
            ));
            $this->db->where('type', "international_shipping_cost");
            $this->db->update('business_settings', array(
                'value' => $this->input->post('international_shipping_cost')
            )); 
