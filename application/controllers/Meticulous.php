...
class Meticulous extends CI_Controller
{
    ...
    { 
        ...
        $page_data['page_name'] = "home/home1";
    ...
    function cart($para1 = '', $para2 = '', $para3 = '', $para4 = '')
    {
        ...
        if ($para1 == "add") {
            ...
            $data = array(
                ...
                'express_shipping' => $this->crud_model->get_shipping_cost($para2, 'express_shipping'),
                'international_shipping' => $this->crud_model->get_shipping_cost($para2, 'international_shipping'),
        ...
        if ($para1 == 'change_delivery_option') {
            if ($delivery_option = $this->input->get('delivery_option')) {
        ...
        if ($para1 == 'calcs') {
            ...
            if (!empty($this->session->userdata('delivery_option'))) {  
                $delivery_option = $this->session->userdata('delivery_option');
                $method          = ($delivery_option !== '') ? $delivery_option . '_shipping' : ''; 

                if ($this->crud_model->get_type_name_by_id('business_settings', '3', 'value') == 'product_wise') {
                    $shipping = $this->crud_model->cart_total_it($method);
                } elseif ($this->crud_model->get_type_name_by_id('business_settings', '3', 'value') == 'fixed') {
                    $shipping = $this->crud_model->get_settings_value('business_settings', $method.'_cost');
                } 
            }
    ...
    function cart_checkout($para1 = "")
    {
        ...
        if ($para1 == "orders") {
            $this->load->view('meticulous/shopping_cart/order_set');
        } elseif ($para1 == "delivery_options") {
            $this->load->view('meticulous/shopping_cart/delivery_options');
        } elseif ($para1 == "delivery_address") {
            $this->load->view('meticulous/shopping_cart/delivery_address');
        } elseif ($para1 == "payments_options") {
            $this->load->view('meticulous/shopping_cart/payments_options');
        } else {
